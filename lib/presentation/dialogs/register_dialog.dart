  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<RegisterBloc, RegisterState>(
      ...
      builder: (context, state) => AlertDialog(
        title: Text('Bienvenido - Proceso de registro'),
        content: Form(
          ...
          ElevatedButton(
            ...
            onPressed: () {
              if (formKey.currentState!.validate()) {
                print('Entre al modulo validado - Registro');
                final signInBloc = BlocProvider.of<RegisterBloc>(context);
                signInBloc.add(RegisterEvent.registerInWithEmail());
              }
            },
          ),
        ],
